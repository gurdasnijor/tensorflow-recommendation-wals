...
def recommendation():
  ...
  rec_list = rec_util.get_recommendations(user_id, nrecs_int)
...
def destinations():
  dest_list = rec_util.get_destination_map()
  json_response = jsonify(dest_list)
  return json_response, 200


@app.route('/users', methods=['GET'])
def users():
  user_list = rec_util.get_user_map()
  json_response = jsonify(user_list)
  return json_response, 200
